...
- N+1 queries are always a [Must] - they degrade linearly with data growth
...
- `$guarded = []` on a model = always a [Must]
- Missing Form Request on a write endpoint = [Recommend] at minimum
