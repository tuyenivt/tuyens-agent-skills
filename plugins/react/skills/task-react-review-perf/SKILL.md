...
Use skill: `stack-detect` to confirm React. If the detected stack is not React, stop and tell the user to invoke `/task-code-review-perf` instead - this workflow assumes React 19+ and TypeScript strict mode.
