...
| `incident-root-cause` | `root-cause-hypothesis`, `ops-observability-fetch`                     | `ops-failure-classification`, `review-blast-radius`, `failure-propagation-analysis`, `architecture-concurrency`, `architecture-data-consistency`, `backend-db-indexing`, `ops-resiliency`, `ops-observability`, `ops-backward-compatibility`, `review-change-risk`                                                         |
