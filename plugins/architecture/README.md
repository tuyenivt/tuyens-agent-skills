...
| `design-reference-pattern`      | Extract a design-doc house pattern from a company template or approved prior design - section skeleton, depth, diagram and approval conventions | `task-design-brief`, `task-design-architecture`, `task-migrate-architecture`                  |
