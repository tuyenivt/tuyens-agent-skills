...
| `rust-tech-lead`           | Rust tech lead for code review and engineering standards. Reviews for idiomatic Rust, error handling, ownership safety, and async patterns.               |
| `rust-reliability-engineer`| Rust reliability engineer for incident analysis in Rust/Axum/PostgreSQL environments. Tokio runtime profiling, task leak detection, connection pool tuning.|
...
| `rust-refactoring-expert`  | Systematic Rust code improvement: trait extraction, error handling modernization, ownership simplification, async safety.                                 |
| `rust-technical-writer`    | Rustdoc comments, utoipa OpenAPI annotations, ADRs, and runbooks for Rust/Axum services.                                                                 |
...
| `rust-code-reviewer`       | Persistent reviewer with session context - tracks recurring patterns and idiomatic Rust compliance across PRs.                                           |
...
| `rust-incident-commander`  | Orchestrates incident response, postmortem, and follow-up tracking for Rust/Axum systems.                                                                 |
