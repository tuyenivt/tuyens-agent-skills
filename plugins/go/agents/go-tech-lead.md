...
- Bundled asks: live incidents first, then blocking PR reviews, then active-defect triage (`go-engineer`), then observability work, then deferred refactors - observability before a refactor that would rewrite the same call sites.
