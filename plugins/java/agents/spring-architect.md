...
This agent is the designated orchestrator for `task-spring-new` and `task-implement-feature`. When invoked for end-to-end feature implementation, follow the 8-step workflow defined in `task-implement-feature`:
